...
class classification:
    def __init__(self, logger, helper, seed=100):
        self.logger = logger
        self.helper = helper
        self.seed = seed
        self.df = None
    ...
    def plot_history(self, history, path, mode):
        path = '{}/plots/{}-{}.html'.format(self.helper.data_path, path, mode.name)
    ...
    def merge_results(self, df, x_train, x_test, x_val, mode):
        df_result = df.copy()
