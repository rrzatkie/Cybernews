...
class cleaner:
    ...
    def load_state(self, helper):
        ...
        self.stopwords = helper.load_state(class_name, 'stopwords', file_helper.VarType.OBJECT, path='{}/downloaded/stopwords'.format(helper.data_path))
    ...
    def build(self, load_path='02_scrap_articles', save_path='03_clean_entries'):
        ...
        try:
            ...
            if self.df is None: 
                self.df=helper.load_df_from_csv(load_path)
